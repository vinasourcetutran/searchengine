...
{
    [ParseChildren(true)]
    public abstract class CustomBasePager : Control, INamingContainer, IPostBackEventHandler
    {
        // Fields
        public const int DEFAULT_MAX_DISPLAY_PAGES = 5;
        public const int DEFAULT_PAGE_SIZE = 20;
        private ITemplate descriptionTemplate;
        private bool isDatabound;
        
        // Methods
        protected CustomBasePager()
        {
        }
        ...
        public string PagerDescriptionText
        {
            ...
            set
            {
                if ((value == null) || (value.Length == 0))
                {
                    this.ViewState["PagerDescriptionText"] = string.Empty;//"Page {0} of {1} ({2} item(s))";
                }
                else
                {
